...
const Home: FunctionComponent<HomeProps> = () => {
  const [data, setData] = useState<IEntity.Book | null>(null);
  ...
  return (
    <>
      ...
      <Box padding='0 100px' mt='36px'>
        ...
        <Grid container item>
          <Box width='500px' display='flex' alignItems='start'>
            <Card sx={{ marginTop: '20px', transition: 'all 0.2s', width: '397px', height: 'auto', padding: '32px', display: 'flex', flexDirection: 'column', gap: '16px', borderRadius: '12px', }} variant="outlined">
